...
def run_tests():
    ...
    initial_overview = json.loads(urllib.request.urlopen(req).read().decode())
    ...
    req = urllib.request.Request(f'{BASE}/payments/analyze', data=data, headers=headers)
    ...
    req = urllib.request.Request(f'{BASE}/payments?limit=5', headers=headers)
    recent_txns = json.loads(urllib.request.urlopen(req).read().decode())
    ...
    req = urllib.request.Request(f'{BASE}/analytics/overview', headers=headers)
    updated_overview_1 = json.loads(urllib.request.urlopen(req).read().decode())
    ...
    req = urllib.request.Request(f'{BASE}/analytics/overview', headers=headers)
    updated_overview_2 = json.loads(urllib.request.urlopen(req).read().decode())
